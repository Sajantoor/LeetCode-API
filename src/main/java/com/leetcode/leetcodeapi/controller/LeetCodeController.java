...
public class LeetCodeController {
        ...
        @ApiResponse(responseCode = "200", description = "Get LeetCode question by category", content = {
                        @Content(mediaType = "application/json") })
        public ResponseEntity<Object> getQuestionByCategory(
        ...
        @ApiResponse(responseCode = "200", description = "Get LeetCode question by difficulty", content = {
                        @Content(mediaType = "application/json") })
        public ResponseEntity<Object> getQuestionByDifficulty(
        ...
        @ApiResponse(responseCode = "200", description = "Get LeetCode question by category and difficulty", content = {
                        @Content(mediaType = "application/json") })
        public ResponseEntity<Object> getQuestionByCategoryAndDifficulty(
                        @PathVariable @ApiParam(value = "category of the questions", required = true, example = "array", allowableValues = allowableCategories) String category,
                        @PathVariable @ApiParam(value = "difficulty of the questions", required = true, example = "hard", allowableValues = allowableDifficulties) String difficulty) {
        ...
        public ResponseEntity<Object> submit(
                        ...
                        @RequestHeader("Session") @ApiParam(value = "LEETCODE_SESSION cookie", required = true) String leetCodeSession,
                        @RequestHeader("X-CSRF-Token") @ApiParam(value = "X-CSRF-Token cookie", required = true) String csrfToken) {
